...
$influxpass="Eaton"
$db="Eaton"
$Database = "\\mind\c$\Program Files (x86)\Eaton\IntelligentPowerProtector\db\mc2.db"
...
$date=[TimeZone]::CurrentTimeZone.ToLocalTime(([datetime]'1/1/1970').AddMilliseconds($Result.date))
