...
$processes= @("chrome.exe","dropbox.exe","dropboxupdate.exe","GoogleDriveFS.exe","OneDrive.exe","SkypeHost.exe","RuntimeBroker.exe","nvspcaps64.exe","nvsphelper64.exe","NVIDIA Share.exe","NVIDIA Web Helper.exe","ONENOTEM.exe","NCentralRDViewer.exe","steam*","discord*")
